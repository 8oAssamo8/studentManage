...
<body>
	<script type="text/javascript">
		...
		function pageInit() {
			jQuery("#list").jqGrid(
				{
					url : '/studentManage/servlet/CourseServlet?type1=showCourseForJqGrid',
					datatype : "json",
					colNames : [ '课程编号', '课程名称', '学期' ],
					colModel : [
						{
							name : 'courseId',
							index : 'courseId',
				...
				onClickButton : function() {
					...
					if (s == "") {
						...
						$.ajax({
							type : "POST",
							dataType : "json",
							url : '/studentManage/servlet/CourseServlet?type1=deleteCourse',
							data : {
								"ids" : s.toString()
							},
