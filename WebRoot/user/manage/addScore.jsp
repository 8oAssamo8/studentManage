	...
	$(document).ready(function() { //资源加载后才执行的 代码，就放到这个函数中，jquery能保证网页所有资源（html代码，图片，js文件，css文件等）都加载后，才执行此函数
		$("#myform").submit(function() {
			$.ajax({
				type : "POST",
				dataType : "json",
				url : '/studentManage/servlet/ScoreServlet?type1=addScore',
				...
				<div class="card">
					...
					<div class="card-body">
						<form id="myform" method="post">
							...
							<div class="form-group">
								<label class="col-form-label"><h5>成绩</h5></label> <input
									class="form-control" id="score" name="score" type="text"
									placeholder="请输入成绩" required="required"
									pattern="100$|^(\d|[1-9]\d)" title="成绩只能为0~100的整数" maxlength=3>
							</div>
