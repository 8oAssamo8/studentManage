...
<body>
	<script type="text/javascript">
		...
		function pageInit() {
			jQuery("#list").jqGrid(
				{
					url : '/studentManage/servlet/ClassServlet?type1=showClassForJqGrid',
					datatype : "json",
					colNames : [ '班级编号', '班级名称' ],
					colModel : [
						{
				...
				onClickButton : function() {
					...
					if (s == "") {
						...
						$.ajax({
							type : "POST",
							dataType : "json",
							url : '/studentManage/servlet/ClassServlet?type1=deleteClass',
							data : {
								"ids" : s.toString()
							},
