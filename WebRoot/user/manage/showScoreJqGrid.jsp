...
<body>
	<script type="text/javascript">
		$(function() {
			pageInit();
			$("#cb_list").hide(); //不显示全选框（只能选择一项）
		});
		function pageInit() {
			jQuery("#list").jqGrid(
				{
					url : '/studentManage/servlet/ScoreServlet?type1=showScoreForJqGrid',
					datatype : "json",
					colNames : [ '课程编号', '学号', '成绩' ],
					colModel : [
						{
				...
				onClickButton : function() {
					...
					if (s == "") {
						...
						$.ajax({
							type : "POST",
							dataType : "json",
							url : '/studentManage/servlet/ScoreServlet?type1=deleteScore',
							data : {
								"ids" : s.toString()
							},
